...
alcohol consumption for the three beverages between the four years are identifiend with the 
Wilcoxon test. The paired t-test
show similar results, but in this case the difference in the average alcohol consumption
for spirits between 2019 and 2020 appear statistically significant at an $\alpha = 0.5%$
significance level.
